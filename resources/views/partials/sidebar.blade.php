    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 me-2">
                            <h6 class="mb-0">Satria Bintang Abadi</h6>
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ route('products.index') }}" class="pc-link"><span class="pc-micon">
                            <svg class="pc-icon">
                                <use xlink:href="#custom-text-block"></use>
                            </svg> </span><span class="pc-mtext">Product</span></a>
                </li>
                <li class="pc-item">
                    <a href="{{ route('categories.index') }}" class="pc-link"><span class="pc-micon">
                            <svg class="pc-icon">
                                <use xlink:href="#custom-text-block"></use>
                            </svg> </span><span class="pc-mtext">Category</span></a>
                </li>
